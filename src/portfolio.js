...
const greeting = {
  username: "Bagus Java",
  title: "Hi all, I'm Bagus Java",
  subTitle: emoji(
    "A passionate Full Stack Software Developer 🚀 having an experience of building Web and Mobile applications with JavaScript / Reactjs / Nodejs / React Native and some other cool libraries and frameworks."
  ),
  resumeLink:
    "https://drive.google.com/file/d/1jZRg0riu2eicWM8YHuZpxDQ5elYWIPk7/view?usp=sharing",
...
const educationInfo = {
  ...
  schools: [
    {
      schoolName: "UIN Maulana Malik Ibrahim - UIN Malang",
      logo: require("./assets/images/harvardLogo.png"),
      subHeader: "Master of Science in Computer Science",
      duration: "Januari 2021 - Present",
...
const blogSection = {
  title: "Blogs",
  subtitle:
    "With Love for Developing oooocomkkmkmkmol stuff, I love to write and teach others what I have learnt.",
...
const podcastSection = {
  ...
  subtitle: "I LOVE TO TALK ABOUT MYSELF AND TECHNOLOGY - OKAY",
...
const twitterDetails = {
  userName: "bagusjavaid", //Replace "twitter" with your twitter username without @
  display: true // Set true to display this section, defaults to false
};
